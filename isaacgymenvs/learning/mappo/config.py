...
def get_config():
    ...
    parser.add_argument('--num_predators', type=int, default=2)
    parser.add_argument('--num_preys', type=int, default=1)
    parser.add_argument('--episode_len_sec', type=float, default=15)
    parser.add_argument('--agg_phy_steps', type=int, default=4)
    parser.add_argument('--agg_act_steps', type=int, default=2)
    parser.add_argument('--act_type', type=str, choices=["vel", "waypoint", "discrete", "multidiscrete"], default="vel")
    parser.add_argument('--act_mix', type=float, default=1.0)
    parser.add_argument('--episodes_per_update', type=int, default=4)
    parser.add_argument('--tanh_normal', action="store_true", default=False)
    parser.add_argument('--map', type=str, default="square")
    parser.add_argument('--sde', action="store_true", default=False, help="use state dependent exploration")

    # curriculum learning
    parser.add_argument('--use_vel_cl', action="store_true", default=False)    
    parser.add_argument('--success_threshold', type=float, default=0.9)
    parser.add_argument('--max_vel', type=float, default=2., help="final vel for training")
    parser.add_argument('--min_vel', type=float, default=0., help="start vel for training, discrete")

    parser.add_argument('--buffer_length', type=int, default=10000)
    parser.add_argument('--restart_p', type=float, default=0.7)
    parser.add_argument('--restart_easy', type=float, default=0.2)
    parser.add_argument('--use_diversified', action="store_true", default=False)
    parser.add_argument('--use_start_states', action="store_true", default=False)
    parser.add_argument('--use_states_clip', action="store_true", default=False)
    parser.add_argument('--sigma_min', type=float, default=0.5)
    parser.add_argument('--sigma_max', type=float, default=0.9)
    parser.add_argument('--metric_T', type=int, default=5)
    return parser
